...
async def backtest_lab_page(request: Request):
    """Backtest Lab - Compare different backtest strategies"""
    from app.data import run_backtest_comparison

    signals = get_signals()

    # Run comparison between standard and EMA-smoothed strategies
